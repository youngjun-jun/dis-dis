...
#         data = np.load(os.path.join(path,'shapes3d.npz'))
...
class dsprites(Dataset):
    ...
    def __init__(self,
        ...
        self.original_resolution = original_resolution
        # self.data = BaseLMDB(path, original_resolution, zfill=7)
        data = np.load(os.path.join(path,'dsprites_ndarray_co1sh3sc6or40x32y32_64x64.npz'))
        self.data = data["imgs"]
        self.length = len(self.data)
...
class CelebaHQ(Dataset):
    ...
    def __init__(self,
        ...
        self.original_resolution = original_resolution
        # self.data = BaseLMDB(path, original_resolution, zfill=7)
        data = np.load(os.path.join(path,'celeba-hq_128.npz'))
...
class Shapes3DTrain(Shapes3D):
    def __init__(self, **kwargs):
        ...
        super().__init__(path='/nfs/home/youngjun/NeurIPS2024/datasets/shapes3d',
...
class MPI3DTrain(MPI3D):
    def __init__(self, **kwargs):
        super().__init__(path='/nfs/home/youngjun/NeurIPS2024/datasets/mpi3d_toy',
                original_resolution=None,
                **kwargs)
...
class Cars3DTrain(Cars3D):
    def __init__(self, **kwargs):
        super().__init__(path='/nfs/home/youngjun/NeurIPS2024/datasets/cars3d',
                original_resolution=None,
                **kwargs)


class dspritesTrain(dsprites):
    def __init__(self, **kwargs):
        super().__init__(path='/nfs/home/youngjun/NeurIPS2024/datasets/raw_data',
                original_resolution=None,
                **kwargs)

class CelebaTrain(Celeba):
    def __init__(self, **kwargs):
        super().__init__(path='/nfs/home/youngjun/NeurIPS2024/datasets',
                image_size=64,
                original_resolution=None,
                crop_d2c=True,
                **kwargs)

class CelebaHQTrain(CelebaHQ):
    def __init__(self, **kwargs):
        super().__init__(path='/nfs/home/youngjun/NeurIPS2024/datasets',
                original_resolution=None,
                **kwargs)
